<%-- 
    Document   : Home.jsp
    Created on : Dec 12, 2021, 7:49:23 AM
    Author     : naren
--%>
...
<html>
    <head>
        ...
        <script>
            String path = "C:\\Coursework\\Fall 21\\Web Tools & Methods\\Netbeans\\HomeToGo\\src\\main\\resources\\Images\\bg_1.jpg";
        </script>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <section class="firstpage">
                ...
                <section class="titles">
                    ...
                    <p>
                        "The World is a Book filled with Adventures and those who do not explore read only one page".
                    </p>
                </section>
                ...
                <section class="container-boxes">
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                <h3>Book Now</h3>
                                <p>Book Now And Fly Around The Globe With the accommodation of your choice.</p>
                            </a>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                <h3>Best Price</h3>
                                <p>We Offer multiple types of rentals and even better the best price too."</p>
                            </a>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                <h3>MEMBER</h3>
                                <p>Join our membership program and get to list your property on our website!</p>
                            </a>
                        </div>
                    </div>
                </section>
