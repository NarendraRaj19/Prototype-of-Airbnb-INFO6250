<%-- 
    Document   : header.jsp
    Created on : Dec 12, 2021, 10:37:52 AM
    Author     : naren
--%>
...
<html>
        ...
        <style>
            * {
            ...
            body {
                margin: 0;
                padding: 0;
                background: url(/HomeToGo/resources/images/register2.jpg) no-repeat; 
    ...
    <body>
        <header>
            ...
            <nav>
                <ul>
                    <li><a href="http://localhost:8081/HomeToGo/index.htm">Home</a></li>
                    <!--                    <li><a href="about.html">About</a></li>
                                        <li><a href="travel.html">Travel</a></li>-->
                    <li><a href="http://localhost:8081/HomeToGo/user/login.htm">Sign In</a></li>
                    <li><a href="http://localhost:8081/HomeToGo/user/register.htm">Register</a></li>
                </ul>
            </nav>
        </header>
    </body>
