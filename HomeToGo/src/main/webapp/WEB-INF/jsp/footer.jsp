        ...
        <div class="footer">
            <div class="footer-content">
                <div class="footer-section about">
                    <h1 class="logo-text"><span><strong>HomeToGo</strong></span></h1>
                    <p>HomeToGo is an American online home rental company for consumer and small business travel. 
                ...
                <div class="footer-section contact" style="text-align: center;">
                    ...
                    <br>
                    <span><i class="fas fa-envelope"></i>&nbsp; <a href="mailto:xyz@gmail.com" style="color: #d3d3d3;">narenrj95@gmail.com</a></span>
                    <br>
            ...
            <div class="footer-bottom" style="color: #d3d3d3;">
                &copy; hometogo.com | <a href="TermsOfUse.html" style="color: #d3d3d3;" >Web Dev Tools Project By Naren</a>
            </div>    
